...
public class CodeGenerator {
    ...
    //数据库
    private static final String url = "jdbc:mysql://120.78.165.181:3306/mkqy?useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static final String driverName = "com.mysql.jdbc.Driver";
    private static final String userName = "mkqy";
